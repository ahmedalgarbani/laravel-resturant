    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query){
                ...
                $edit = '';
                $delete = '';
                if (\Gate::allows('why-choose-us-edit')) {
                    $edit = "<a class='btn btn-success btn-sm  ' href='".route('admin.why-choose-us.edit',$query->id)."'><i class='far fa-edit'></i></a>";
                }
                if (\Gate::allows('why-choose-us-delete')) {
                ...
                return "<i class='".($query->icon)."' width='100px'></i>";
